...
Graphics are original interface diagrams, an SVG chart, and geometric digital print designs. No copied logo artwork or third-party product photography is used. Google Fonts are optional; system fonts are used when offline.
...
The page is prepared for go.misiki.tech. GitHub Pages serves the root of the main branch; pushes to main publish updates automatically. The custom domain is not configured. For other static hosting upload index.html, style.css, and app.js together.
